...
arr = [0, 3, 99, 15, 16, 55, 44, -31, 500]    #500 - максимальное число его индекс - 8, следовательно заменят первую половину
arr2 = [7, 77, 343, 15, 19, 99, 100, 521]   #521 - максимальное число его индекс - 7, следовательно заменят вторую половину
mx_odd =0
mx_even = 0
